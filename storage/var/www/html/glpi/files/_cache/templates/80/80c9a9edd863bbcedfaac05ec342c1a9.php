...
class __TwigTemplate_cedd968a1316a511de6ff015b7535ead extends Template
{
    private $source;
    private $macros = [];
...
($context["rand"] ?? null)]], 40, $context, $this->getSourceContext());
   ...
   ";
        ...
        // line 44
        echo "   ";
        $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Ajax::updateItemOnSelectEvent", [("dropdown_dcrooms_id" .         // line 46
($context["rand"] ?? null)), "room_positions", ($this->extensions['Glpi\Application\View\Extension\ConfigExtension']->config("root_doc") . "/ajax/dcroom_size.php"), ["id" => "__VALUE__", "current" =>         // line 51
($context["current_position"] ?? null), "rand" =>         // line 52
($context["rand"] ?? null)]]);
        // line 55
        echo "   ";
        $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Ajax::updateItemOnSelectEvent", [("dropdown_dcrooms_id" .         // line 57
($context["rand"] ?? null)), ("dropdown_locations_id" .         // line 58
($context["rand"] ?? null)), ($this->extensions['Glpi\Application\View\Extension\ConfigExtension']->config("root_doc") . "/ajax/dropdownLocation.php"), ["items_id" => "__VALUE__", "itemtype" => "DCRoom"]]);
   ...
   ";
        ...
        // line 67
        echo "      ";
        if (((($__internal_compile_2 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 67)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["dcrooms_id"] ?? null) : null) > 0)) {
            // line 68
            echo "         ";
            ...
            if ( !(null === ($context["dcroom"] ?? null))) {
                // line 70
                echo "            ";
                $context["used"] = twig_get_attribute($this->env, $this->source, ($context["dcroom"] ?? null), "getFilled", [($context["current_position"] ?? null)], "method", false, false, false, 70);
                // line 71
                echo "            ";
...
";
    ...
    {
        return new Source("", "pages/assets/rack.html.twig", "/var/www/html/glpi/templates/pages/assets/rack.html.twig");
    }
}
